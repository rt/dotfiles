...
setup_playground() {
  ...
  tmux send-keys -t $sess:js "cd ~/projects/playground/src/javascript" Enter
  tmux send-keys -t $sess:js "vim repl.md" Enter
  
  tmux split-window -v -l 24 -t $sess:js
  tmux send-keys -t $sess:js.2 "cd ~/projects/playground/src/javascript" Enter
  ...
  tmux send-keys -t $sess:java "cd ~/projects/playground/src/java" Enter
  tmux send-keys -t $sess:java "vim repl.md" Enter
  
  tmux split-window -v -l 24 -t $sess:java
  tmux send-keys -t $sess:java.2 "cd ~/projects/playground/src/java" Enter
  ...
  tmux send-keys -t $sess:postgres "cd ~/projects/playground/src/postgres" Enter
  tmux send-keys -t $sess:postgres "vim repl.md" Enter
  
  tmux split-window -v -l 24 -t $sess:postgres
  tmux send-keys -t $sess:postgres.2 "cd ~/projects/playground/src/postgres" Enter
  ...
  tmux send-keys -t $sess:bash "cd ~/projects/playground/src/bash" Enter
  tmux send-keys -t $sess:bash "vim repl.md" Enter
  
  tmux split-window -v -l 24 -t $sess:bash
  tmux send-keys -t $sess:bash.2 "cd ~/projects/playground/src/bash" Enter
  ...
  tmux send-keys -t $sess:python "cd ~/projects/playground/src/python" Enter
  tmux send-keys -t $sess:python "vim repl.md" Enter
  
  tmux split-window -v -l 24 -t $sess:python
  tmux send-keys -t $sess:python.2 "cd ~/projects/playground/src/python" Enter
  ...
  tmux send-keys -t $sess:go "cd ~/projects/playground/src/go" Enter
  tmux send-keys -t $sess:go "vim repl.md" Enter
  
  tmux split-window -v -l 24 -t $sess:go
  tmux send-keys -t $sess:go.2 "cd ~/projects/playground/src/go" Enter
  ...
  tmux send-keys -t $sess:groovy "cd ~/projects/playground/src/groovy" Enter
  tmux send-keys -t $sess:groovy "vim repl.md" Enter
  
  tmux split-window -v -l 24 -t $sess:groovy
  tmux send-keys -t $sess:groovy.2 "cd ~/projects/playground/src/groovy" Enter
  ...
  tmux send-keys -t $sess:clojure "cd ~/projects/playground/src/clojure" Enter
  tmux send-keys -t $sess:clojure "vim repl.md" Enter
  
  tmux split-window -v -l 24 -t $sess:clojure
  tmux send-keys -t $sess:clojure.2 "cd ~/projects/playground/src/clojure" Enter
  ...
  tmux send-keys -t $sess:git "cd ~/projects/playground/src/git" Enter
  tmux send-keys -t $sess:clojure "vim repl.md" Enter

  tmux split-window -v -l 24 -t $sess:git
  tmux send-keys -t $sess:git.2 "cd ~/projects/playground/src/git/origin" Enter

  tmux split-window -v -l 24 -t $sess:git
  tmux send-keys -t $sess:git.3 "cd ~/projects/playground/src/git/client1" Enter

  tmux split-window -h -l 50 -t $sess:git
  tmux send-keys -t $sess:git.4 "cd ~/projects/playground/src/git/client2" Enter
